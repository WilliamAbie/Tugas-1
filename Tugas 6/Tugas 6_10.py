# Implementasi overloading pada class ComputerPart
...
class HardDiskSATA(ComputerPart):
    ...
    def overload(self,kapasitas = None): # Metode Overloading
        if self.kapasitas > 1000 :
            print("Laptop anda berkapasitas besar")
        else:
            print("Laptop anda kurang memori")

p = Processor("AMD","Ryzen 3 3250U",3500000,2,"2.6 GHz")
r = RandomAccessMemory("Corsaire","DDR4 SODIMM PC19200/2400 MHz",990000,"8 GB")
hdd = HardDiskSATA("Toshiba","HDD 2.5 inch",295000,500,7200)

part = [p,r,hdd]
for x in part:
    print('\n{} {} produksi {} berharga {}'.format(x.jenis,x.nama,x.pabrikan,x.harga))

# Pemanggilan Metode Overloading
hdd.overload()